...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [74.004627, 15.293951, 394122.906250, 1692210.875000], maxZoom: 28, minZoom: 2, projection: new ol.proj.Projection({
            code: 'EPSG:32643',
...
layerSwitcher.showPanel();
    ...
    var searchLayer = new SearchLayer({
      layer: lyr_FieldsCurtorimHandiKurishandi_kuris__curtorim__fields_1,
      colName: 'S_No',
      zoom: 10,
      collapsed: true,
      map: map
...
map.getView().fit([74.004627, 15.293951, 394122.906250, 1692210.875000], map.getSize());
